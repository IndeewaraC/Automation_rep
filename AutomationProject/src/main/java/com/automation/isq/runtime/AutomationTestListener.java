...
/**
 * The listener interface for receiving AutomationTest events. The class that is
 * interested in processing a AutomationTest event implements this interface, and the
 * object created with that class is registered with a component using the
 * component's <code>addAutomationTestListener</code> method. When the AutomationTest event
 * occurs, that object's appropriate method is invoked.
 * 
 * @see AutomationTestEvent
 */
public class AutomationTestListener implements IInvokedMethodListener {
    ...
    /**
     * Gets the data table meta.
     * 
     * @param tableName
     *            the table name
     * @return the data table meta
     */
    ...
    public static final void setBrowser(final String browserString) {
        AutomationTestListener.browser = browserString;
    }
