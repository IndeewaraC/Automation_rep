...
public class SeleneseTestBaseVir {
    ...
    public final void configWebDriver(final String browserName) {
        if (browserName.toLowerCase(Locale.ROOT).contains("chrome")) {
            ...
            setWebDriverCapabilities(new DesiredCapabilities());
            setDefaultProfile(new FirefoxProfile());
            File chromedriver = getGeckoDriverServerExecutables();
    ...
    /**
     * Checks the os architecture and returns the gecko driver file.
     * 
     * @return File of the gecko driver executable.
     */
    private  File getGeckoDriverServerExecutables() {
    	  String os =
                  System.getProperty("os.name").toLowerCase(Locale.getDefault());
          File file = null;
          if (os.contains("win")) {
              ...
              if (isx64bit()) {
                  file =
                          new File("src" + File.separator + "main"
                                  + File.separator + "resources" + File.separator
                                  + "lib" + File.separator
                                  + "geckodriver_linux(x64)");
              } else {
                  file =
                          new File("src" + File.separator + "main"
                                  + File.separator + "resources" + File.separator
                                  + "lib" + File.separator
                                  + "geckodriver_linux(x86)");
              }
          }
